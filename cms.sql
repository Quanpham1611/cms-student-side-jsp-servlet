...
insert into Course values
		...
		alter table Course add dateBegin date, dateEnd date
...
CREATE TABLE CourseContent (
		...
		alter table CourseContent add timeAdd date, dateBegin date, dateEnd date
...
insert into CourseContent
		...
		alter table CourseContent add timeAdd DATE
...
create table SubmitExam(
	...
	alter table SubmitExam add SubmissionTime datetime
...
CREATE TABLE Practise (
        ...
        VALUES 
            ...
            QuestionId NVARCHAR(30) REFERENCES Question(Id),
        ...
        VALUES
            ...
            PRIMARY KEY (UserId, CourseId, PractiseId) -- Tạo khóa chính từ các khóa ngoại
        );
