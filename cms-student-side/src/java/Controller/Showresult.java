...
public class Showresult extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Result s = new Result();
        ArrayList<Result> rsl = s.getResult(userId, courseId, practiseId);
        
        request.setAttribute("rsl", rsl);
        request.setAttribute("courseName", courseName);
        request.getRequestDispatcher("tableshowresult.jsp").forward(request, response);
    } 
